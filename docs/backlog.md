...
| SOS-10 | Today page v0 | ui | 08, 09 | AppTest: ordering `tier, pinned, score`; Why bullets; Complete/Snooze/↑/↓/Dismiss write `user_feedback`; refresh button with per-connector status; renders with HubSpot ⚠ | review |
